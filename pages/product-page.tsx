...
const Index: NextPage = () => {
  ...
  return (
    <Container style={{ padding: "15px" }} className="product_page_wrapper p-3">
      <div
      ...
      <Container  className="p-0">
        ...
        <Container fluid style={{ padding: "0" }}>
          <Row>
            ...
            <Col className="mb-3">{product?.weight} г</Col>
            ...
            <Container fluid>
              ...
              <Row className="my-4" style={{ width: "300px" }}>
                <Col>
                  <h4>
                    {(product?.proteins ? parseInt(product?.proteins) : 0) * 4 +
                      (product?.fats ? parseInt(product?.fats) : 0) * 9 +
                      (product?.carbohydrates
                        ? parseInt(product?.carbohydrates)
                        : 0) *
                        4}
                  </h4>
