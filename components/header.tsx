...
function Header(): JSX.Element {
  ...
  return (
    <>
      <Navbar bg="light" expand="lg" className="header_container mb-4 px-4 py-3 sticky-top">
        ...
        <Nav className="nav d-flex align-items-center justify-content-end " style={{ flexWrap: 'nowrap', fontSize: '14px', letterSpacing: '-0.5px' }}>
          {/* Нужно деоделать модальное окно */}
          <AdressBar />
          <Cart />
          <Login />
