...
const Counter = ({ increment, decrement, count = 0 }: { increment: Function, decrement: Function, count: number }): JSX.Element => {
  return (
    <>
      {count > 0 ? 
      <div style={{minWidth:'100px', }} className=" rounded-5 w-100 text-light counter_button ">
        ...
        <button onClick={(e) => {
          ...
          increment();
            ...
            style={{minWidth:'100px', display:"flex", justifyContent:"center",maxHeight:"45px", border:'none', background:'white', boxShadow:"0px 0px 10px rgba(0, 0, 0, 0.25)"}}
        >
